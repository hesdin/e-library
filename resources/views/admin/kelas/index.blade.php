            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="kelas" class="form-control" name="kelas" placeholder="Masukkan Nama Kelas">
                    ...
                    <div class="mb-10">
                        ...
                        <select class="form-select form-control" id="wali_kelas_id" name="wali_kelas_id"
                            data-control="select2" data-placeholder="Pilih Wali Kelas">
                            <option></option>
                            @foreach ($wali_kelas as $val)
                                <option value="{{ $val->id }}">{{ $val->nama }}</option>
                            @endforeach
                        </select>
                        <small class="text-danger wali_kelas_id_error"></small>
                    </div>  
...
<script>
    ...
    $(document).on('click', '.btn-update', function(e) {
        e.preventDefault();
        let url = '/kelas/show/' + $(this).attr('data-uuid');
    ...
    $(document).on('submit', ".form-data", function(e) {
     ...
     $(document).on('click', '.btn-delete', function(e) {
        e.preventDefault();
        let url = '/kelas/delete/' + $(this).attr('data-uuid');
