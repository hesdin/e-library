<div class="menu-item">
  ...
  <a class="menu-link {{ $path[0] == 'kompetensi-dasar' ? 'active' : '' }}" href="{{ route('kompetensi_dasar.index') }}">
    <span class="menu-icon">
  ...
  <div data-kt-menu-trigger="click"
    class="menu-item menu-accordion {{ in_array($path[0], ['jurnal', 'absensi']) ? 'hover show' : '' }}">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
      <div class="menu-item">
        @foreach ($topics as $topic)
          <a class="menu-link {{ $path[0] == 'library' && $path[1] == 'library' && $path[2] == $topic->id ? 'active' : '' }}"
