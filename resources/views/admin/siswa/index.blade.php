            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="number" id="nomor_whatsaap" class="form-control" name="nomor_whatsaap" placeholder="Masukkan Nomor whatsaap">
                        <small class="text-danger nomor_whatsaap_error"></small>
                    </div>
                    
                    <div class="mb-10">
                        <label class="form-label">Nama Wali</label>
                        <input type="text" id="nama_wali" class="form-control" name="nama_wali" placeholder="Masukkan nama wali">
                    ...
                    <div class="mb-10 row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" id="pekerjaan_wali" class="form-control" name="pekerjaan_wali" placeholder="Masukkan Pekerjaan Wali">
                            <small class="text-danger pekerjaan_wali_error"></small>  
                        </div>
                        <div class="col-lg-6">
                            <label class="form-label">Penghasilan Wali</label>
                            <input type="number" id="penghasilan_wali" class="form-control" name="penghasilan_wali" placeholder="Masukkan Penghasilan Wali">
