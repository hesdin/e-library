                ...
                <div class="col-md-4">
                  ...
                  <div class="card-xl-stretch me-md-6">
                    ...
                    <div class="m-0">
                      <!--begin::Title-->
                      <a href="#"
                        class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">{{ $video->judul }}</a>
                      <!--end::Title-->
                      <!--begin::Content-->
                      <div class="fs-6 fw-bolder">
                        <!--begin::Author-->
                        <a href="#" class="text-gray-700 text-hover-primary">Mata Pelajaran :
                          {{ $video->mata_pelajaran }}</a>
                        <!--end::Author-->
                        <!--begin::Date-->
                        {{-- <span class="text-muted">Kelas {{ $video->tingkatan }}</span> --}}
                        <!--end::Date-->
                      </div>
                      <!--end::Content-->
                      <!--begin::Text-->
                ...
                <div class="col-md-4">
                  ...
                  <div class="card-xl-stretch me-md-6">
                    ...
                    <a class="d-block overlay iframe" href="{{ asset($ebook->file_url) }}">
                      ...
                      <div
                        class="overlay-wrapper card-rounded min-h-250px d-flex align-items-center justify-content-center bg-primary text-white text-center"
                        style="display: none;">
                        <div>
                    ...
                    <div class="mt-5">
                      <!--begin::Title-->
                      <a href="#"
                        class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">{{ $ebook->judul }}</a>
                      <!--end::Title-->
                      <!--begin::Content-->
                      <div class="fs-6 fw-bolder">
                        <!--begin::Author-->
                        <a href="#" class="text-gray-700 text-hover-primary">Mata Pelajaran :
                          {{ $ebook->mata_pelajaran }}</a>
                        <!--end::Author-->
                        <!--begin::Date-->
                        {{-- <span class="text-muted">Kelas {{ $video->tingkatan }}</span> --}}
                        <!--end::Date-->
