            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="mata_pelajaran" class="form-control" name="mata_pelajaran" placeholder="Masukkan Mata Pelajaran">
                        <small class="text-danger mata_pelajaran_error"></small>
                    </div>

                    <div class="cmb-10">
                        <label class="form-label">Guru Mata Pelajaran</label>
                        <select class="form-select form-control" id="tenaga_kependidikan_id" name="tenaga_kependidikan_id"
                        ...
                        <small class="text-danger tenaga_kependidikan_id_error"></small>
                    </div>
...
<script>
    ...
    $(document).on('click', '#btn-side-form', function() {
        OverlayForm('Tambah', 'Mata Pelajaran',null);
    })
    ...
    $(document).on('click', '.btn-update', function(e) {
        e.preventDefault();
        let url = '/mata-pelajaran/show/' + $(this).attr('data-uuid');
        OverlayForm('Update', 'Mata Pelajaran', url);
    })
    ...
    $(document).on('submit', ".form-data", function(e) {
        ...
        if (type == 'add') {
            ...
            url = `/mata-pelajaran/update/${uuid}`;
            module = "Update";
        }
    ...
    $(document).on('click', '.btn-delete', function(e) {
        e.preventDefault();
        let url = '/mata-pelajaran/delete/' + $(this).attr('data-uuid');
    ...
    function initDatatable() {
        ...
        processing: true,
        searching: true,
        ajax: "{{ route('mata_pelajaran.datatable') }}",
        columns: [
            {
                data: null,
        ...
        columnDefs: [{
                ...
                render: function(data, type, full, meta) {
                    return `
                            ...
                            <button class="btn btn-sm btn-clean btn-delete btn-icon" data-uuid="${data}" data-label="${full.kode}" data-type="destroy">
