					...
					<div class="aside-footer flex-column-auto py-5" id="kt_aside_footer">
                        ...
                        <div class="mb-5">
                            <a class="menu-link text-white" href="">
										...
										<span class="menu-title">Aplication v1.0.0</span>
									</a>
                        </div>
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="header-brand">
							<!--begin::Logo-->
							<a href="#">
                                {{-- <p class="text-white fw-bolder">SMA Negeri 1 Makassar</p> --}}
                                <h2 class="text-white">LibraNet</h2>
							...
							<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
									...
									<div class="d-flex align-items-center">
										...
										<a class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary" href="#">
