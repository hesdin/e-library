                ...
                <form class="form-data">
                    ...
                    <div class="mb-10 row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="date" id="tanggal_lahir" class="form-control" name="tanggal_lahir" placeholder="Masukkan Tanggal Lahir">
                    ...
                    <div class="mb-10">
                        ...
                        <select class="form-control" id="jabatan" name="jabatan" data-control="select2" data-placeholder="Pilih Jabatan">
                            <option></option>
