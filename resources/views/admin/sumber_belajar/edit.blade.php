            ...
            <div class="row">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h3 class="card-title mb-0">Edit Sumber Belajar</h3>
                                    ...
                                    <form class="form-data">
                                        ...
                                        <div class="mb-10 row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mt-3 {{ $data->thumb_img ? '' : 'd-none' }}" id="thumbPreviewWrapper">
                                                    <img src="{{ $data->thumb_img ?? '' }}" alt="Preview Thumbnail" class="img-fluid rounded" id="thumbPreview">
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    document.addEventListener("trix-initialize", function (event) {
        if (event.target.getAttribute("input") !== "deskripsi") {
            return;
        }
        event.target.editor.loadHTML(@json($data->deskripsi));
    });
