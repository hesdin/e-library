                ...
                <div
                  ...
                  <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        ...
                        <a
                            class="menu-link {{ $path[0] == 'kompetensi-dasar' ? 'active' : '' }}"
                        ...
                        <a
                            class="menu-link {{ $path[0] == 'jurnal' ? 'active' : '' }}"
                 ...
                 <div
                  ...
                  <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        ...
                        <a
                            class="menu-link {{ $path[0] == 'capaian-kompetensi' ? 'active' : '' }}"
                        ...
                        <a
                            class="menu-link {{ $path[0] == 'penilaian-sikap' ? 'active' : '' }}"
