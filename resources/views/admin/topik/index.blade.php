            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="topik" class="form-control" name="topik" placeholder="Masukkan Topik">
                        <small class="text-danger topik_error"></small>
                    </div>
...
<script>
    ...
    $(document).on('click', '.btn-update', function(e) {
        e.preventDefault();
        let url = '/topik/show/' + $(this).attr('data-uuid');
        OverlayForm('Update', 'Topik', url);
    })
    ...
    $(document).on('click', '.btn-delete', function(e) {
        e.preventDefault();
        let url = '/topik/delete/' + $(this).attr('data-uuid');
