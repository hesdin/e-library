    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
      ...
      <div id="kt_content_container" class="container">
        ...
        <button class="btn btn-success btn-sm mb-5" data-bs-toggle="modal" data-bs-target="#importModal">
          Import Data Tenaga Kependidikan
        </button>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="importModalLabel">Import Data Tenaga Kependidikan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <form action="{{ route('import-tenaga-kependidikan') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3">
        ...
        <form class="form-data">
          ...
          <div class="mb-10">
            ...
            <select class="form-control" id="status_kepegawaian" name="status_kepegawaian">
              <option disabled selected>Pilih Status Kepegewaian</option>
          ...
          <div class="mb-10">
            ...
            <select class="form-control" id="jabatan" name="jabatan" data-control="select2"
              data-placeholder="Pilih Jabatan">
              <option></option>
              <option value="kepala_sekolah">Kepala Sekolah</option>
              <option value="guru">Guru</option>
              <option value="staf_tata_usahan">Staf Tata Usaha</option>
...
@section('script')
  <script>
    ...
    $(document).on('click', '.btn-update', function(e) {
      e.preventDefault();
      let url = '/tenaga-kependidikan/show/' + $(this).attr('data-uuid');
    ...
    $(document).on('submit', ".form-data", function(e) {
      ...
      if (type == 'add') {
        url = "{{ route('tenaga_kependidikan.store') }}";
        module = "Tambah";
      } else {
        let uuid = $("input[name='uuid']").val();
        url = `/tenaga-kependidikan/update/${uuid}`;
        module = "Update";
      }
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.success == true) {
            swal
              .fire({
                text: `Tenaga Kependidikan berhasil di ${module}`,
                icon: "success",
    ...
    $(document).on('click', '.btn-delete', function(e) {
      e.preventDefault();
      let url = '/tenaga-kependidikan/delete/' + $(this).attr('data-uuid');
    ...
    function initDatatable() {
      ...
      $('#kt_table_data').DataTable({
        ...
        processing: true,
        searching: true,
        ajax: "{{ route('tenaga_kependidikan.datatable') }}",
        columns: [{
          data: null,
        ...
        columnDefs: [{
          ...
          render: function(data, type, full, meta) {
            return `
                            ...
                            <button class="btn btn-sm btn-clean btn-delete btn-icon" data-uuid="${data}" data-label="${full.nip}" data-type="destroy">
